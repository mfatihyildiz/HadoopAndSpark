...
public class Main {
    ...
    // Map spark dataset to list of POJO objects, in the form of dataset again.
    //
    public static void main(String[] args) {
        ...
        // Tthe generic is not <Row> now, but model class <Emp>.
        //
        Dataset<Emp> emp = res.map(new MapFunction<Row, Emp>(){
            @Override
        ...
        Emp en = emp.filter("empno == 7788").first();
